...
public abstract class EarthquakeMarker extends SimplePointMarker
{
	...
	public void draw(PGraphics pg, float x, float y) {
		...
		//float age =  Float.parseFloat(getProperty("age").toString());
		//if(age=="Past day")
	...
	private void colorDetermine(PGraphics pg) {
		...
		if(depth<THRESHOLD_INTERMEDIATE) pg.fill(250,250,0);
		if(depth>=THRESHOLD_INTERMEDIATE && depth <THRESHOLD_DEEP) pg.fill(0,0,250);
		if(depth >= THRESHOLD_DEEP) pg.fill(250,0,0);
	}
